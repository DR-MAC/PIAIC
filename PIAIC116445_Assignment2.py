...
def function3():
    ...
    x = a.reshape((1000,))[34:1001:35] #wrtie your code here
    return x
    """
    Expected Output:
...
def function6():
    ...
    arr = [0,0,0,0,10,0,0,20,0,0] #wrtie your code here
...
def function7():
    ...
    return np.array([0]*len(x), x.dtype) #write your code here
...
def function12():
    ...
    arr = np.array([1,2,3])
    ans = np.hstack([[arr[i]]*3,arr] for i in range(0,3)).reshape(18,) #write your code here 
